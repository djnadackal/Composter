  ...
  return (
    <div className="min-h-screen bg-[#060010] text-white font-[font]">
      ...
      <div className="fixed w-screen h-2 top-20 pointer-events-none">
        <div className="absolute inset-0 bg-linear-to-b from-[#251c35] to-transparent" 
             style={{
               maskImage: 'linear-gradient(to right, transparent 0%, black 55%, black 1%, transparent 100%)',
               WebkitMaskImage: 'linear-gradient(to right, transparent 0%, black 55%, black 1%, transparent 100%)'
             }}
        ></div>
      </div>
